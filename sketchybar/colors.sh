...
# -- Nelson's Custom Scheme --
#export BAR_COLOR=0xffb3db86
#export ITEM_BG_COLOR=0xff667a38
#export ACCENT_COLOR=0xff667a38

# Green 
# -- Nelson Second Custom --
 export BAR_COLOR=0xff1e1e2e
 export ITEM_BG_COLOR=0xff1e1e2e
 export ACCENT_COLOR=0xffa6e3a1

#Red
#export BAR_COLOR=0xffa50c0e
